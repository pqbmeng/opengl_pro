...
void initVBO()
{
	...
	0.0, 0.0, 1.0, // 1 back left top
	0.0, 1.0, 0.0, // 2 back right bottom
	0.0, 1.0, 1.0, // 3 back right top
    1.0, 0.0, 0.0, // 4 front left bottom
    1.0, 0.0, 1.0, // 5 front left top
    1.0, 1.0, 0.0, // 6 front right bottom
    1.0, 1.0, 1.0  // 7 front right top
    };
